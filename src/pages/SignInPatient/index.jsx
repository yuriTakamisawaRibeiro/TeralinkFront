...
export const SigninPatient = () => {
    ...
    const handleRegisterClick = async () => {
        ...
        const user = {
            userType: '1', // Adiciona o userType automaticamente com valor '1'
            name,
            cpf,
            email,
            password
        ...
        try {
            await api.post('/auth/signup', user); // Certifique-se de que a rota '/auth/signup' está correta
            alert('Usuário cadastrado com sucesso!');
            setName('');
            setCpf('');
            setEmail('');
            setPassword('');
            setConfirmPassword(''); // Limpa o campo de confirmação de senha
