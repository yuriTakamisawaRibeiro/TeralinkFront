...
import { Container, Background1, DataArea, Title,Area, ButtonArea, BackButton } from "./styles"
    ...
    return (
        <Container>
            ...
            <DataArea style={{ alignItems: 'center' }}>
                ...
                <a href="/userpatientprofileinfo"><ProfileOption title="Informações pessoais" subtitle="Nome completo, email e CPF" /></a>
                <a href="/userpatientprofilecredentials"><ProfileOption title="Credenciais" subtitle="Gerenciar senha e conta" /></a>
                <ButtonArea>
